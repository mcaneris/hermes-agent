...
TOOLSETS = {
    ...
    "hermes-microsoft-teams": {
        "description": "Microsoft Teams bot toolset - enterprise messaging via Teams and Bot Framework (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-homeassistant", "hermes-email", "hermes-sms", "hermes-mattermost", "hermes-matrix", "hermes-dingtalk", "hermes-feishu", "hermes-wecom", "hermes-microsoft-teams"]
    }
}
